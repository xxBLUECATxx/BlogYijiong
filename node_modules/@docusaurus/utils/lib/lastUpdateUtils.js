...
exports.LAST_UPDATE_FALLBACK = void 0;
...
async function readLastUpdateData(filePath, options, lastUpdateFrontMatter) {
    ...
    const getLastUpdateBy = () => getLastUpdateMemoized().then((update) => update?.lastUpdatedBy);
    const getLastUpdateAt = () => getLastUpdateMemoized().then((update) => update?.lastUpdatedAt);
